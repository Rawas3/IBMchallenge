...
var IamAccessGroupsV2 = /** @class */ (function (_super) {
    ...
    IamAccessGroupsV2.prototype.createAccessGroup = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(IamAccessGroupsV2.DEFAULT_SERVICE_NAME, 'v2', 'createAccessGroup');
        var parameters = {
            options: {
                url: '/v2/groups',
                method: 'POST',
    ...
    IamAccessGroupsV2.prototype.listAccessGroups = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(IamAccessGroupsV2.DEFAULT_SERVICE_NAME, 'v2', 'listAccessGroups');
        var parameters = {
            options: {
                url: '/v2/groups',
                method: 'GET',
    ...
    IamAccessGroupsV2.prototype.getAccessGroup = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(IamAccessGroupsV2.DEFAULT_SERVICE_NAME, 'v2', 'getAccessGroup');
        var parameters = {
            options: {
    ...
    IamAccessGroupsV2.prototype.updateAccessGroup = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(IamAccessGroupsV2.DEFAULT_SERVICE_NAME, 'v2', 'updateAccessGroup');
        var parameters = {
            options: {
                url: '/v2/groups/{access_group_id}',
                method: 'PATCH',
    ...
    IamAccessGroupsV2.prototype.deleteAccessGroup = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(IamAccessGroupsV2.DEFAULT_SERVICE_NAME, 'v2', 'deleteAccessGroup');
        var parameters = {
            options: {
                url: '/v2/groups/{access_group_id}',
                method: 'DELETE',
    ...
    IamAccessGroupsV2.prototype.isMemberOfAccessGroup = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(IamAccessGroupsV2.DEFAULT_SERVICE_NAME, 'v2', 'isMemberOfAccessGroup');
        var parameters = {
            options: {
    ...
    IamAccessGroupsV2.prototype.addMembersToAccessGroup = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(IamAccessGroupsV2.DEFAULT_SERVICE_NAME, 'v2', 'addMembersToAccessGroup');
        var parameters = {
            options: {
    ...
    IamAccessGroupsV2.prototype.listAccessGroupMembers = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(IamAccessGroupsV2.DEFAULT_SERVICE_NAME, 'v2', 'listAccessGroupMembers');
        var parameters = {
            options: {
                url: '/v2/groups/{access_group_id}/members',
                method: 'GET',
    ...
    IamAccessGroupsV2.prototype.removeMemberFromAccessGroup = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(IamAccessGroupsV2.DEFAULT_SERVICE_NAME, 'v2', 'removeMemberFromAccessGroup');
        var parameters = {
            options: {
                url: '/v2/groups/{access_group_id}/members/{iam_id}',
                method: 'DELETE',
    ...
    IamAccessGroupsV2.prototype.removeMembersFromAccessGroup = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(IamAccessGroupsV2.DEFAULT_SERVICE_NAME, 'v2', 'removeMembersFromAccessGroup');
        var parameters = {
            options: {
    ...
    IamAccessGroupsV2.prototype.removeMemberFromAllAccessGroups = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(IamAccessGroupsV2.DEFAULT_SERVICE_NAME, 'v2', 'removeMemberFromAllAccessGroups');
        var parameters = {
            options: {
    ...
    IamAccessGroupsV2.prototype.addMemberToMultipleAccessGroups = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(IamAccessGroupsV2.DEFAULT_SERVICE_NAME, 'v2', 'addMemberToMultipleAccessGroups');
        var parameters = {
            options: {
                url: '/v2/groups/_allgroups/members/{iam_id}',
                method: 'PUT',
    ...
    IamAccessGroupsV2.prototype.addAccessGroupRule = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(IamAccessGroupsV2.DEFAULT_SERVICE_NAME, 'v2', 'addAccessGroupRule');
        var parameters = {
            options: {
    ...
    IamAccessGroupsV2.prototype.listAccessGroupRules = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(IamAccessGroupsV2.DEFAULT_SERVICE_NAME, 'v2', 'listAccessGroupRules');
        var parameters = {
            options: {
                url: '/v2/groups/{access_group_id}/rules',
                method: 'GET',
    ...
    IamAccessGroupsV2.prototype.getAccessGroupRule = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(IamAccessGroupsV2.DEFAULT_SERVICE_NAME, 'v2', 'getAccessGroupRule');
        var parameters = {
            options: {
    ...
    IamAccessGroupsV2.prototype.replaceAccessGroupRule = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(IamAccessGroupsV2.DEFAULT_SERVICE_NAME, 'v2', 'replaceAccessGroupRule');
        var parameters = {
            options: {
                url: '/v2/groups/{access_group_id}/rules/{rule_id}',
                method: 'PUT',
    ...
    IamAccessGroupsV2.prototype.removeAccessGroupRule = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(IamAccessGroupsV2.DEFAULT_SERVICE_NAME, 'v2', 'removeAccessGroupRule');
        var parameters = {
            options: {
                url: '/v2/groups/{access_group_id}/rules/{rule_id}',
                method: 'DELETE',
    ...
    IamAccessGroupsV2.prototype.getAccountSettings = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(IamAccessGroupsV2.DEFAULT_SERVICE_NAME, 'v2', 'getAccountSettings');
        var parameters = {
            options: {
    ...
    IamAccessGroupsV2.prototype.updateAccountSettings = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(IamAccessGroupsV2.DEFAULT_SERVICE_NAME, 'v2', 'updateAccountSettings');
        var parameters = {
            options: {
                url: '/v2/groups/settings',
                method: 'PATCH',
