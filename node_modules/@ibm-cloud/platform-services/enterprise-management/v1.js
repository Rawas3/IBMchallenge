...
var EnterpriseManagementV1 = /** @class */ (function (_super) {
    ...
    EnterpriseManagementV1.prototype.createEnterprise = function (params) {
        ...
        var requiredParams = ['sourceAccountId', 'name', 'primaryContactIamId'];
        ...
        var sdkHeaders = common_1.getSdkHeaders(EnterpriseManagementV1.DEFAULT_SERVICE_NAME, 'v1', 'createEnterprise');
        var parameters = {
            options: {
                url: '/enterprises',
                method: 'POST',
    ...
    EnterpriseManagementV1.prototype.listEnterprises = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(EnterpriseManagementV1.DEFAULT_SERVICE_NAME, 'v1', 'listEnterprises');
        var parameters = {
            options: {
                url: '/enterprises',
                method: 'GET',
    ...
    EnterpriseManagementV1.prototype.getEnterprise = function (params) {
        var _params = __assign({}, params);
        var requiredParams = ['enterpriseId'];
        var missingParams = ibm_cloud_sdk_core_1.getMissingParams(_params, requiredParams);
        if (missingParams) {
            return Promise.reject(missingParams);
        }
        ...
        var sdkHeaders = common_1.getSdkHeaders(EnterpriseManagementV1.DEFAULT_SERVICE_NAME, 'v1', 'getEnterprise');
        var parameters = {
            options: {
    ...
    EnterpriseManagementV1.prototype.updateEnterprise = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(EnterpriseManagementV1.DEFAULT_SERVICE_NAME, 'v1', 'updateEnterprise');
        var parameters = {
            options: {
                url: '/enterprises/{enterprise_id}',
                method: 'PATCH',
    ...
    EnterpriseManagementV1.prototype.importAccountToEnterprise = function (params) {
        var _params = __assign({}, params);
        var requiredParams = ['enterpriseId', 'accountId'];
        var missingParams = ibm_cloud_sdk_core_1.getMissingParams(_params, requiredParams);
        if (missingParams) {
            return Promise.reject(missingParams);
        }
        ...
        var sdkHeaders = common_1.getSdkHeaders(EnterpriseManagementV1.DEFAULT_SERVICE_NAME, 'v1', 'importAccountToEnterprise');
        var parameters = {
            options: {
    ...
    EnterpriseManagementV1.prototype.createAccount = function (params) {
        var _params = __assign({}, params);
        var requiredParams = ['parent', 'name', 'ownerIamId'];
        var missingParams = ibm_cloud_sdk_core_1.getMissingParams(_params, requiredParams);
        if (missingParams) {
            return Promise.reject(missingParams);
        }
        ...
        var sdkHeaders = common_1.getSdkHeaders(EnterpriseManagementV1.DEFAULT_SERVICE_NAME, 'v1', 'createAccount');
        var parameters = {
            options: {
                url: '/accounts',
                method: 'POST',
    ...
    EnterpriseManagementV1.prototype.listAccounts = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(EnterpriseManagementV1.DEFAULT_SERVICE_NAME, 'v1', 'listAccounts');
        var parameters = {
            options: {
                url: '/accounts',
                method: 'GET',
    ...
    EnterpriseManagementV1.prototype.getAccount = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(EnterpriseManagementV1.DEFAULT_SERVICE_NAME, 'v1', 'getAccount');
        var parameters = {
            options: {
    ...
    EnterpriseManagementV1.prototype.updateAccount = function (params) {
        var _params = __assign({}, params);
        var requiredParams = ['accountId', 'parent'];
        var missingParams = ibm_cloud_sdk_core_1.getMissingParams(_params, requiredParams);
        if (missingParams) {
            return Promise.reject(missingParams);
        }
        ...
        var sdkHeaders = common_1.getSdkHeaders(EnterpriseManagementV1.DEFAULT_SERVICE_NAME, 'v1', 'updateAccount');
        var parameters = {
            options: {
                url: '/accounts/{account_id}',
                method: 'PATCH',
    ...
    EnterpriseManagementV1.prototype.createAccountGroup = function (params) {
        var _params = __assign({}, params);
        var requiredParams = ['parent', 'name', 'primaryContactIamId'];
        var missingParams = ibm_cloud_sdk_core_1.getMissingParams(_params, requiredParams);
        if (missingParams) {
            return Promise.reject(missingParams);
        }
        ...
        var sdkHeaders = common_1.getSdkHeaders(EnterpriseManagementV1.DEFAULT_SERVICE_NAME, 'v1', 'createAccountGroup');
        var parameters = {
            options: {
                url: '/account-groups',
                method: 'POST',
    ...
    EnterpriseManagementV1.prototype.listAccountGroups = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(EnterpriseManagementV1.DEFAULT_SERVICE_NAME, 'v1', 'listAccountGroups');
        var parameters = {
            options: {
                url: '/account-groups',
                method: 'GET',
    ...
    EnterpriseManagementV1.prototype.getAccountGroup = function (params) {
        var _params = __assign({}, params);
        var requiredParams = ['accountGroupId'];
        var missingParams = ibm_cloud_sdk_core_1.getMissingParams(_params, requiredParams);
        if (missingParams) {
            return Promise.reject(missingParams);
        }
        ...
        var sdkHeaders = common_1.getSdkHeaders(EnterpriseManagementV1.DEFAULT_SERVICE_NAME, 'v1', 'getAccountGroup');
        var parameters = {
            options: {
    ...
    EnterpriseManagementV1.prototype.updateAccountGroup = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(EnterpriseManagementV1.DEFAULT_SERVICE_NAME, 'v1', 'updateAccountGroup');
        var parameters = {
            options: {
                url: '/account-groups/{account_group_id}',
                method: 'PATCH',
