...
var IbmCloudShellV1 = /** @class */ (function (_super) {
    ...
    IbmCloudShellV1.prototype.getAccountSettings = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(IbmCloudShellV1.DEFAULT_SERVICE_NAME, 'v1', 'getAccountSettings');
        var parameters = {
            options: {
    ...
    IbmCloudShellV1.prototype.updateAccountSettings = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(IbmCloudShellV1.DEFAULT_SERVICE_NAME, 'v1', 'updateAccountSettings');
        var parameters = {
            options: {
                url: '/api/v1/user/accounts/{account_id}/settings',
                method: 'POST',
