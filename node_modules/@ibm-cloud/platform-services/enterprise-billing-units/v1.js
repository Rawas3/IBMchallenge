...
var EnterpriseBillingUnitsV1 = /** @class */ (function (_super) {
    ...
    EnterpriseBillingUnitsV1.prototype.getBillingUnit = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(EnterpriseBillingUnitsV1.DEFAULT_SERVICE_NAME, 'v1', 'getBillingUnit');
        var parameters = {
            options: {
    ...
    EnterpriseBillingUnitsV1.prototype.listBillingUnits = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(EnterpriseBillingUnitsV1.DEFAULT_SERVICE_NAME, 'v1', 'listBillingUnits');
        var parameters = {
            options: {
    ...
    EnterpriseBillingUnitsV1.prototype.listBillingOptions = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(EnterpriseBillingUnitsV1.DEFAULT_SERVICE_NAME, 'v1', 'listBillingOptions');
        var parameters = {
            options: {
    ...
    EnterpriseBillingUnitsV1.prototype.getCreditPools = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(EnterpriseBillingUnitsV1.DEFAULT_SERVICE_NAME, 'v1', 'getCreditPools');
        var parameters = {
            options: {
                url: '/v1/credit-pools',
                method: 'GET',
