...
var OpenServiceBrokerV1 = /** @class */ (function (_super) {
    ...
    OpenServiceBrokerV1.prototype.getServiceInstanceState = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(OpenServiceBrokerV1.DEFAULT_SERVICE_NAME, 'v1', 'getServiceInstanceState');
        var parameters = {
            options: {
    ...
    OpenServiceBrokerV1.prototype.replaceServiceInstanceState = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(OpenServiceBrokerV1.DEFAULT_SERVICE_NAME, 'v1', 'replaceServiceInstanceState');
        var parameters = {
            options: {
                url: '/bluemix_v1/service_instances/{instance_id}',
                method: 'PUT',
    ...
    OpenServiceBrokerV1.prototype.replaceServiceInstance = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(OpenServiceBrokerV1.DEFAULT_SERVICE_NAME, 'v1', 'replaceServiceInstance');
        var parameters = {
            options: {
    ...
    OpenServiceBrokerV1.prototype.updateServiceInstance = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(OpenServiceBrokerV1.DEFAULT_SERVICE_NAME, 'v1', 'updateServiceInstance');
        var parameters = {
            options: {
                url: '/v2/service_instances/{instance_id}',
                method: 'PATCH',
    ...
    OpenServiceBrokerV1.prototype.deleteServiceInstance = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(OpenServiceBrokerV1.DEFAULT_SERVICE_NAME, 'v1', 'deleteServiceInstance');
        var parameters = {
            options: {
                url: '/v2/service_instances/{instance_id}',
                method: 'DELETE',
    ...
    OpenServiceBrokerV1.prototype.listCatalog = function (params) {
        var _params = __assign({}, params);
        var sdkHeaders = common_1.getSdkHeaders(OpenServiceBrokerV1.DEFAULT_SERVICE_NAME, 'v1', 'listCatalog');
        var parameters = {
            options: {
                url: '/v2/catalog',
                method: 'GET',
    ...
    OpenServiceBrokerV1.prototype.getLastOperation = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(OpenServiceBrokerV1.DEFAULT_SERVICE_NAME, 'v1', 'getLastOperation');
        var parameters = {
            options: {
    ...
    OpenServiceBrokerV1.prototype.replaceServiceBinding = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(OpenServiceBrokerV1.DEFAULT_SERVICE_NAME, 'v1', 'replaceServiceBinding');
        var parameters = {
            options: {
    ...
    OpenServiceBrokerV1.prototype.deleteServiceBinding = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(OpenServiceBrokerV1.DEFAULT_SERVICE_NAME, 'v1', 'deleteServiceBinding');
        var parameters = {
            options: {
                url: '/v2/service_instances/{instance_id}/service_bindings/{binding_id}',
                method: 'DELETE',
