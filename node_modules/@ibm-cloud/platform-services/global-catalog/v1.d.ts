...
declare class GlobalCatalogV1 extends BaseService {
     ...
     */
    deleteCatalogEntry(params: GlobalCatalogV1.DeleteCatalogEntryParams): Promise<GlobalCatalogV1.Response<GlobalCatalogV1.Empty>>;
    /**
     ...
     * @returns {Promise<GlobalCatalogV1.Response<GlobalCatalogV1.Empty>>}
     */
    restoreCatalogEntry(params: GlobalCatalogV1.RestoreCatalogEntryParams): Promise<GlobalCatalogV1.Response<GlobalCatalogV1.Empty>>;
    /*************************
     * visibility
     ************************/
    /**
     ...
     * @returns {Promise<GlobalCatalogV1.Response<GlobalCatalogV1.Empty>>}
     */
    updateVisibility(params: GlobalCatalogV1.UpdateVisibilityParams): Promise<GlobalCatalogV1.Response<GlobalCatalogV1.Empty>>;
    /*************************
     * pricing
     ************************/
    /**
     ...
     */
    getArtifact(params: GlobalCatalogV1.GetArtifactParams): Promise<GlobalCatalogV1.Response<NodeJS.ReadableStream | Buffer>>;
    /**
     * Upload artifact.
     *
     ...
     * @returns {Promise<GlobalCatalogV1.Response<GlobalCatalogV1.Empty>>}
     */
    uploadArtifact(params: GlobalCatalogV1.UploadArtifactParams): Promise<GlobalCatalogV1.Response<GlobalCatalogV1.Empty>>;
    /**
     * Delete artifact.
     *
     ...
     * @returns {Promise<GlobalCatalogV1.Response<GlobalCatalogV1.Empty>>}
     */
    deleteArtifact(params: GlobalCatalogV1.DeleteArtifactParams): Promise<GlobalCatalogV1.Response<GlobalCatalogV1.Empty>>;
}
/*************************
 * interfaces
 ************************/
declare namespace GlobalCatalogV1 {
    ...
    interface CreateCatalogEntryParams {
    ...
    namespace CreateCatalogEntryConstants {
    ...
    interface GetCatalogEntryParams {
    ...
    interface UpdateCatalogEntryParams {
    ...
    namespace UpdateCatalogEntryConstants {
        /** The type of catalog entry, **service**, **template**, **dashboard**, which determines the type and shape of the object. */
        enum Kind {
            SERVICE = "service",
            TEMPLATE = "template",
    ...
    interface DeleteCatalogEntryParams {
        /** The object's unique ID. */
        id: string;
        /** This changes the scope of the request regardless of the authorization header. Example scopes are `account`
         *  and `global`. `account=global` is reqired if operating with a service ID that has a global admin policy, for
    ...
    interface GetChildObjectsParams {
    ...
    interface RestoreCatalogEntryParams {
    ...
    /** Deployment-related metadata. */
    interface CatalogEntryMetadataDeployment {
    ...
    /** Pricing-related information. */
    interface CatalogEntryMetadataPricing {
    ...
    /** Information related to the accounts for which a catalog entry is visible. */
    interface VisibilityDetailAccounts {
