...
var GlobalSearchV2 = /** @class */ (function (_super) {
    ...
    GlobalSearchV2.prototype.search = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(GlobalSearchV2.DEFAULT_SERVICE_NAME, 'v2', 'search');
        var parameters = {
            options: {
    ...
    GlobalSearchV2.prototype.getSupportedTypes = function (params) {
        var _params = __assign({}, params);
        var sdkHeaders = common_1.getSdkHeaders(GlobalSearchV2.DEFAULT_SERVICE_NAME, 'v2', 'getSupportedTypes');
        var parameters = {
            options: {
