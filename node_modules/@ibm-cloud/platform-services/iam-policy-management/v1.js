...
var IamPolicyManagementV1 = /** @class */ (function (_super) {
    ...
    IamPolicyManagementV1.prototype.listPolicies = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(IamPolicyManagementV1.DEFAULT_SERVICE_NAME, 'v1', 'listPolicies');
        var parameters = {
            options: {
                url: '/v1/policies',
                method: 'GET',
    ...
    IamPolicyManagementV1.prototype.createPolicy = function (params) {
        var _params = __assign({}, params);
        var requiredParams = ['type', 'subjects', 'roles', 'resources'];
        var missingParams = ibm_cloud_sdk_core_1.getMissingParams(_params, requiredParams);
        if (missingParams) {
            return Promise.reject(missingParams);
        }
        ...
        var sdkHeaders = common_1.getSdkHeaders(IamPolicyManagementV1.DEFAULT_SERVICE_NAME, 'v1', 'createPolicy');
        var parameters = {
            options: {
                url: '/v1/policies',
                method: 'POST',
    ...
    IamPolicyManagementV1.prototype.updatePolicy = function (params) {
        var _params = __assign({}, params);
        var requiredParams = ['policyId', 'ifMatch', 'type', 'subjects', 'roles', 'resources'];
        var missingParams = ibm_cloud_sdk_core_1.getMissingParams(_params, requiredParams);
        if (missingParams) {
            return Promise.reject(missingParams);
        }
        ...
        var sdkHeaders = common_1.getSdkHeaders(IamPolicyManagementV1.DEFAULT_SERVICE_NAME, 'v1', 'updatePolicy');
        var parameters = {
            options: {
    ...
    IamPolicyManagementV1.prototype.getPolicy = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(IamPolicyManagementV1.DEFAULT_SERVICE_NAME, 'v1', 'getPolicy');
        var parameters = {
            options: {
                url: '/v1/policies/{policy_id}',
                method: 'GET',
    ...
    IamPolicyManagementV1.prototype.deletePolicy = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(IamPolicyManagementV1.DEFAULT_SERVICE_NAME, 'v1', 'deletePolicy');
        var parameters = {
            options: {
                url: '/v1/policies/{policy_id}',
                method: 'DELETE',
    ...
    IamPolicyManagementV1.prototype.patchPolicy = function (params) {
        var _params = __assign({}, params);
        var requiredParams = ['policyId', 'ifMatch'];
        var missingParams = ibm_cloud_sdk_core_1.getMissingParams(_params, requiredParams);
        if (missingParams) {
            return Promise.reject(missingParams);
        }
        ...
        var sdkHeaders = common_1.getSdkHeaders(IamPolicyManagementV1.DEFAULT_SERVICE_NAME, 'v1', 'patchPolicy');
        var parameters = {
            options: {
                url: '/v1/policies/{policy_id}',
                method: 'PATCH',
    ...
    IamPolicyManagementV1.prototype.listRoles = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(IamPolicyManagementV1.DEFAULT_SERVICE_NAME, 'v1', 'listRoles');
        var parameters = {
            options: {
                url: '/v2/roles',
                method: 'GET',
    ...
    IamPolicyManagementV1.prototype.createRole = function (params) {
        var _params = __assign({}, params);
        var requiredParams = ['displayName', 'actions', 'name', 'accountId', 'serviceName'];
        var missingParams = ibm_cloud_sdk_core_1.getMissingParams(_params, requiredParams);
        if (missingParams) {
            return Promise.reject(missingParams);
        }
        ...
        var sdkHeaders = common_1.getSdkHeaders(IamPolicyManagementV1.DEFAULT_SERVICE_NAME, 'v1', 'createRole');
        var parameters = {
            options: {
                url: '/v2/roles',
                method: 'POST',
    ...
    IamPolicyManagementV1.prototype.updateRole = function (params) {
        var _params = __assign({}, params);
        var requiredParams = ['roleId', 'ifMatch'];
        var missingParams = ibm_cloud_sdk_core_1.getMissingParams(_params, requiredParams);
        if (missingParams) {
            return Promise.reject(missingParams);
        }
        ...
        var sdkHeaders = common_1.getSdkHeaders(IamPolicyManagementV1.DEFAULT_SERVICE_NAME, 'v1', 'updateRole');
        var parameters = {
            options: {
    ...
    IamPolicyManagementV1.prototype.getRole = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(IamPolicyManagementV1.DEFAULT_SERVICE_NAME, 'v1', 'getRole');
        var parameters = {
            options: {
                url: '/v2/roles/{role_id}',
                method: 'GET',
    ...
    IamPolicyManagementV1.prototype.deleteRole = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(IamPolicyManagementV1.DEFAULT_SERVICE_NAME, 'v1', 'deleteRole');
        var parameters = {
            options: {
                url: '/v2/roles/{role_id}',
                method: 'DELETE',
