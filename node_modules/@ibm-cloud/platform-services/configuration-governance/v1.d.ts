 ...
 */
declare class ConfigurationGovernanceV1 extends BaseService {
     ...
     */
    static newInstance(options: UserOptions): ConfigurationGovernanceV1;
    /**
     ...
     */
    createRules(params: ConfigurationGovernanceV1.CreateRulesParams): Promise<ConfigurationGovernanceV1.Response<ConfigurationGovernanceV1.CreateRulesResponse>>;
    /**
     * List rules.
     *
     ...
     */
    listRules(params: ConfigurationGovernanceV1.ListRulesParams): Promise<ConfigurationGovernanceV1.Response<ConfigurationGovernanceV1.RuleList>>;
    /**
     * Get a rule.
     *
     ...
     */
    getRule(params: ConfigurationGovernanceV1.GetRuleParams): Promise<ConfigurationGovernanceV1.Response<ConfigurationGovernanceV1.Rule>>;
    /**
     * Update a rule.
     *
     ...
     * @returns {Promise<ConfigurationGovernanceV1.Response<ConfigurationGovernanceV1.Rule>>}
     */
    updateRule(params: ConfigurationGovernanceV1.UpdateRuleParams): Promise<ConfigurationGovernanceV1.Response<ConfigurationGovernanceV1.Rule>>;
    /**
     * Delete a rule.
     *
     ...
     */
    deleteRule(params: ConfigurationGovernanceV1.DeleteRuleParams): Promise<ConfigurationGovernanceV1.Response<ConfigurationGovernanceV1.Empty>>;
    /**
     * Create attachments.
     *
     ...
     */
    createAttachments(params: ConfigurationGovernanceV1.CreateAttachmentsParams): Promise<ConfigurationGovernanceV1.Response<ConfigurationGovernanceV1.CreateAttachmentsResponse>>;
    /**
     * List attachments.
     *
     ...
     */
    listAttachments(params: ConfigurationGovernanceV1.ListAttachmentsParams): Promise<ConfigurationGovernanceV1.Response<ConfigurationGovernanceV1.AttachmentList>>;
    /**
     * Get an attachment.
     *
     ...
     */
    getAttachment(params: ConfigurationGovernanceV1.GetAttachmentParams): Promise<ConfigurationGovernanceV1.Response<ConfigurationGovernanceV1.Attachment>>;
    /**
     ...
     * @returns {Promise<ConfigurationGovernanceV1.Response<ConfigurationGovernanceV1.Attachment>>}
     */
    updateAttachment(params: ConfigurationGovernanceV1.UpdateAttachmentParams): Promise<ConfigurationGovernanceV1.Response<ConfigurationGovernanceV1.Attachment>>;
    /**
     ...
     * @returns {Promise<ConfigurationGovernanceV1.Response<ConfigurationGovernanceV1.Empty>>}
     */
    deleteAttachment(params: ConfigurationGovernanceV1.DeleteAttachmentParams): Promise<ConfigurationGovernanceV1.Response<ConfigurationGovernanceV1.Empty>>;
}
/*************************
 * interfaces
 ************************/
declare namespace ConfigurationGovernanceV1 {
    ...
    interface CreateAttachmentsParams {
        /** The UUID that uniquely identifies the rule. */
        ruleId: string;
    ...
    interface CreateAttachmentsResponse {
        attachments: Attachment[];
    }
    ...
    interface RuleConditionAndLvl2 extends RuleCondition {
        description?: string;
        and: RuleSingleProperty[];
    }
    /** A condition with the `or` logical operator. */
    interface RuleConditionOrLvl2 extends RuleCondition {
        description?: string;
        or: RuleSingleProperty[];
    }
    /** The requirement that must be met to determine the resource's level of compliance in accordance with the rule. To apply a single property check, define a configuration property and the desired value that you want to check against. */
    interface RuleConditionSingleProperty extends RuleCondition {
        description?: string;
        /** A resource configuration variable that describes the property that you want to apply to the target resource.
         *
         *  Available options depend on the target service and resource.
    ...
    interface RuleRequiredConfigMultipleProperties extends RuleRequiredConfig {
    }
    /** The requirement that must be met to determine the resource's level of compliance in accordance with the rule. To apply a single property check, define a configuration property and the desired value that you want to check against. */
    interface RuleRequiredConfigSingleProperty extends RuleRequiredConfig {
        description?: string;
        /** A resource configuration variable that describes the property that you want to apply to the target resource.
         *
         *  Available options depend on the target service and resource.
    ...
    /** A condition with the `and` logical operator. */
    interface RuleRequiredConfigMultiplePropertiesConditionAnd extends RuleRequiredConfigMultipleProperties {
        description?: string;
        and: RuleCondition[];
    }
    /** A condition with the `or` logical operator. */
    interface RuleRequiredConfigMultiplePropertiesConditionOr extends RuleRequiredConfigMultipleProperties {
        description?: string;
        or: RuleCondition[];
    }
}
