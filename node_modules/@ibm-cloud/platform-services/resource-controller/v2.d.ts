...
declare class ResourceControllerV2 extends BaseService {
     ...
     */
    deleteResourceInstance(params: ResourceControllerV2.DeleteResourceInstanceParams): Promise<ResourceControllerV2.Response<ResourceControllerV2.Empty>>;
    /**
     ...
     * @returns {Promise<ResourceControllerV2.Response<ResourceControllerV2.Empty>>}
     */
    deleteResourceKey(params: ResourceControllerV2.DeleteResourceKeyParams): Promise<ResourceControllerV2.Response<ResourceControllerV2.Empty>>;
    /**
     ...
     * @returns {Promise<ResourceControllerV2.Response<ResourceControllerV2.Empty>>}
     */
    deleteResourceBinding(params: ResourceControllerV2.DeleteResourceBindingParams): Promise<ResourceControllerV2.Response<ResourceControllerV2.Empty>>;
    /**
     ...
     * @returns {Promise<ResourceControllerV2.Response<ResourceControllerV2.Empty>>}
     */
    deleteResourceAlias(params: ResourceControllerV2.DeleteResourceAliasParams): Promise<ResourceControllerV2.Response<ResourceControllerV2.Empty>>;
    /**
...
declare namespace ResourceControllerV2 {
    ...
    interface CreateResourceAliasParams {
    ...
    interface ListResourceBindingsForAliasParams {
        /** The short or long ID of the alias. */
        id: string;
        /** Limit on how many items should be returned. */
        limit?: number;
    ...
    interface ListReclamationsParams {
    ...
    interface RunReclamationActionParams {
    ...
    interface ResourceBindingPostParameters {
    ...
    interface ResourceBindingsList {
    ...
    interface ResourceInstancesList {
    ...
    /** Configuration options represented as key-value pairs. Service defined options are passed through to the target resource brokers, whereas platform defined options are not. */
    interface ResourceKeyPostParameters {
        /** An optional platform defined option to reuse an existing IAM serviceId for the role assignment. */
        serviceid_crn?: string;
