...
var GlobalTaggingV1 = /** @class */ (function (_super) {
    ...
    GlobalTaggingV1.prototype.listTags = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(GlobalTaggingV1.DEFAULT_SERVICE_NAME, 'v1', 'listTags');
        var parameters = {
            options: {
                url: '/v3/tags',
                method: 'GET',
    ...
    GlobalTaggingV1.prototype.createTag = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(GlobalTaggingV1.DEFAULT_SERVICE_NAME, 'v1', 'createTag');
        var parameters = {
            options: {
                url: '/v3/tags',
                method: 'POST',
    ...
    GlobalTaggingV1.prototype.deleteTagAll = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(GlobalTaggingV1.DEFAULT_SERVICE_NAME, 'v1', 'deleteTagAll');
        var parameters = {
            options: {
                url: '/v3/tags',
                method: 'DELETE',
    ...
    GlobalTaggingV1.prototype.deleteTag = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(GlobalTaggingV1.DEFAULT_SERVICE_NAME, 'v1', 'deleteTag');
        var parameters = {
            options: {
    ...
    GlobalTaggingV1.prototype.attachTag = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(GlobalTaggingV1.DEFAULT_SERVICE_NAME, 'v1', 'attachTag');
        var parameters = {
            options: {
                url: '/v3/tags/attach',
                method: 'POST',
    ...
    GlobalTaggingV1.prototype.detachTag = function (params) {
        ...
        var sdkHeaders = common_1.getSdkHeaders(GlobalTaggingV1.DEFAULT_SERVICE_NAME, 'v1', 'detachTag');
        var parameters = {
            options: {
                url: '/v3/tags/detach',
                method: 'POST',
