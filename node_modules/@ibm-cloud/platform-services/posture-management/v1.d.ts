 ...
 */
declare class PostureManagementV1 extends BaseService {
     ...
     */
    static newInstance(options: UserOptions): PostureManagementV1;
    /**
     ...
     */
    createValidation(params: PostureManagementV1.CreateValidationParams): Promise<PostureManagementV1.Response<PostureManagementV1.Result>>;
    /*************************
     * profiles
     ************************/
    /**
     ...
     */
    listProfiles(params: PostureManagementV1.ListProfilesParams): Promise<PostureManagementV1.Response<PostureManagementV1.ProfilesList>>;
    /*************************
     * scopes
     ************************/
    /**
     ...
     */
    listScopes(params: PostureManagementV1.ListScopesParams): Promise<PostureManagementV1.Response<PostureManagementV1.ScopesList>>;
}
/*************************
 * interfaces
 ************************/
declare namespace PostureManagementV1 {
